...
<html lang="en">
	<head>
		...
		<!-- Google font -->
		<link href="<?php echo base_url('https://fonts.googleapis.com/css?family=Nunito+Sans:700%7CNunito:300,600') ?>" rel="stylesheet"> 
						...
						<div class="row">
							...
							<div class="col-md-12">
								<div class="post post-row">
									<a class="post-img" href="blog-post.html"><img src="<?php echo base_url().'assets/images/'.$image;?>"></a>
									<div class="post-body">
										<div class="post-meta">
											<a class="post-category cat-2" href="#">JavaScript</a>
											<span class="post-date">March 27, 2018</span>
										</div>
										<h3 class="post-title"><a href='.base_url("artikel/lihat/".$data->id).' ><?php echo $judul;?></a></h3>
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></span>
		...
		<!-- jQuery Plugins -->
		<script src="<?php echo base_url('js/jquery.min.j') ?>"></script>
